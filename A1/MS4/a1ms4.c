...
int main(void)
{
	...
	contact.name.firstName[0] = '\0', contact.name.middleInitial[0] = '\0', contact.name.lastName[0] = '\0';
	contact.address.strtNum = 0, contact.address.strt[0] = '\0', contact.address.aprtNum = 0, contact.address.postal[0] = '\0', contact.address.city[0] = '\0';
	contact.numbers.cell[0] = '\0', contact.numbers.home[0] = '\0', contact.numbers.business[0] = '\0';
	...
	printf("\nAddress Details\n");
	printf("Street number: %d\n", contact.address.strtNum);
	printf("Street name: %s\n", contact.address.strt);
	printf("Apartment: %d\n", contact.address.aprtNum);
